...
:fork_and_knife: & :cocktail: : Columbia City has several [excellent restaurants](https://seattle.eater.com/maps/best-restaurant-columbia-city) but since we're only in the area for two days, we'll keep our food adventures short. You cannot go wrong with [Coffeholic House](https://coffeeholichouse.com/), [Columbia City Bakery](https://www.columbiacitybakery.com/), or [Taproot Cafe](https://www.taprootseattle.com/) for a quick bite. As part of our field trip agenda we'll stop by Happy Hour at [Marination](https://marinationmobile.com/) or [Island Soul](https://www.islandsoulrestaurant.com/) on Friday. On Saturday we'll have a relaxed brunch at [Geraldine's Counter](https://www.geraldinescounter.com/) before the program gets underway but unfortunately lunch will likely be short and hurried given the schedule. If you want a break from the screen I recommend stopping by [Spice Waala](https://www.spicewaala.com/) or [Billiard Hoang](https://share.google/qrjDgcWrefjlVwKpi) before the Saturday PM session. The latter has pool tables for more of a social vibe than a tiny storefront. On both days we'll tentatively go to [Taco City Taqueria](https://tacocitysea.com/) since it's one of the few restaurants open past 9, actual plan TBD day-of.

:calendar: : We're proposing three blocks that best represent TFF 2025's lineup:

* [Feature Friday](#option1)
* [Saturday Cinemarathon](#option2)
* [Short and Sweet Sunday](#option3)


## Feature Friday <a id='option1'></a>         
...
## Saturday Cinemarathon <a id='option2'></a>        
...
I know it's a long day but show up and show out for the morning shorts sessions anywy. Short films don't get enough love in desi circles compared to longer features, but that's where tomorrow's big names cut their teeth. I'm excited to see see Uttera Singh's *Pinch* ([based on a real story](https://timesofindia.indiatimes.com/city/ahmedabad/woman-reports-neighbour-for-harassment-during-navratri-in-ahmedabad/articleshow/114196321.cms)!), Vinay Umapathy's *Behind the Line*, and Pranav Dawar's *Maut Ka Kuan* (Well of Death). You might remember the last from a certain [Hanumankind video](https://www.youtube.com/watch?v=hOHKltAiKXQ). *The Patel Motel Story* looks super interesting too - I only learned about Patels being known for motel chains from a [Nimesh Patel set](https://youtube.com/shorts/Iv-nAH5R83M?si=gBVams2-wWTWHB3o). An [interview with the film directors](https://www.youtube.com/watch?v=pYRXkQdcVK4) was also helpful in tracing the history. The directors highlight a 1999 NYT article titled *[A Patel Motel Cartel?](https://www.nytimes.com/1999/07/04/magazine/a-patel-motel-cartel.html)* which describes this pattern as a "nonlinear ethnic niche: a certain ethnic group becomes entrenched in a clearly identifiable economic sector, working at jobs for which it has no evident cultural, geographical or even racial affinity". The article goes on to discuss caste, chain migration, the Gujarati diaspora from East Africa, and the economics of an aging GI generation selling assets to poor immigrants with surprising clarity. Do read if you can.


<iframe width="560" height="315" src="https://www.youtube.com/embed/fTyCaVm7S3M?si=P9YBZhrVCWcVkSpG" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

<iframe width="560" height="315" src="https://www.youtube.com/embed/fzwspg8hU7A?si=DQkntB-dENyaf76Q" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
The afternoon session truly makes me wish I had a time turner. The two LGBTQIA screening blocks are the obvious highlight here - but don't sleep on the [Aging, Care, and Defiance](https://tffm2025.eventive.org/schedule/68aafe760f680073aa15a022) session. Director Shayar Gandhi's advertising background combined with the bright colors of a Gujarati kitchen makes for luscious cinema in *[Paswaar](https://filmfreeway.com/Paswaar)*. I'll admit I already cried watching the trailer - and it hits harder once you remember how touch-starved we all were post-Covid. 
...
In the afternoon [Queer Horizons](https://tffm2025.eventive.org/schedule/68ab26c735aaa78d6a88e00e) / [Hidden Desires](https://tffm2025.eventive.org/schedule/68ab26c735aaa78d6a88e00a) double session, I'm looking forward to Iniyavan Elumalai's *[Pakka](https://www.imdb.com/title/tt32651287/)* about four gay men figuring out friendship and life on the cricket pitch, as well as Shruti Parekh's *[Zari](https://www.imdb.com/title/tt32311363/)*. I was surprised that the longer feature [We Are Faheem & Karun](https://www.imdb.com/title/tt34284832/) is being billed as Kashmir's first queer love story. [Trans Kashmir](https://www.youtube.com/watch?v=L_7gk0qTYho) was released in 2022, so I'd say we're overdue for some queer stories beyond geopolitical, cis-, and hetero-normative boundaries. Here's an interesting [interview](https://www.youtube.com/watch?v=0mY6fnpp5mc) with writer/director/producer Onir (of *[My Brother... Nikhil](https://www.imdb.com/title/tt0419992/)* fame) - maybe watch this *after* the movie so the themes make sense.
...
## Short and Sweet Sunday <a id='option3'></a>
If you're more into shorts than features anyway, return to TFF/SLFF on Sunday for back-to-back shorts programs. I think these shorts will add a pinch of levity to close out festival weekend. For example, I already know Vidhya Iyer's *Giving Mom the Talk* will make me cringe HARD, and probably for the better?
...
Did you end up going to TFF 2025 and/or find this useful? [Let us know](mailto:socsafceastside@gmail.com)! Happy watching and have a lovely October(Movie)Fest all!
